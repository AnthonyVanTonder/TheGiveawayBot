...
module.exports = {
   ...
   run: async(client, interaction) => {
     ...
     let statsembed = new MessageEmbed()
      ...
      .addField("🌐 Links", "[Website](https://thegiveawaybot.vercel.app)\n[Invite](https://thegiveawaybot.vercel.app/invite.html)\n[Support](https://thegiveawaybot.vercel.app/support.html)", true)
        .setTimestamp()
